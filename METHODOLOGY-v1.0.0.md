...
**Collection Day.** A calendar day on which CCIR executes the data collection pipeline. Collection runs on an automated hourly schedule. The daily index uses the most recent collection completed before midnight UTC.
